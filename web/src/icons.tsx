...
const base = (size: number, stroke: number): JSX.IntrinsicElements['svg'] => ({
  width: size,
  height: size,
  viewBox: '0 0 24 24',
  fill: 'none',
...
export const Spinner = ({ size = 16, stroke = 2.4 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth={stroke} className="spin">
