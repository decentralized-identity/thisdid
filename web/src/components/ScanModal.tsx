...
const corner = (pos: Record<string, unknown>) =>
  ({ position: "absolute", width: 26, height: 26, ...pos }) as const;
...
function extractDid(raw: string): string | null {
  ...
  return v.toLowerCase().startsWith("did:") && v.split(":").length >= 3
    ? v
    : null;
}
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      if (did) {
        ...
        setDetected(true);
        resolveTimer = setTimeout(() => resolveRef.current(did), 650);
      }
    }
      ...
      >
        ...
        <div
          style={{
            ...
            placeItems: "center",
            boxShadow: detected
              ? `inset 0 0 0 2px ${GREEN}, 0 0 26px -6px ${GREEN}`
              : "none",
        ...
        >
          ...
          {!streaming && (
            ...
            >
              ...
              <path
                d="M14 14h3M14 18h3M14 21h7M18 14v3M21 14v7"
                strokeLinecap="round"
              />
            </svg>
          )}
