...
export const FEATURED_METHODS: MethodMeta[] = [
  ...
  // records expired ecosystem-wide after TBD's shutdown (all six DIF spec
  // vectors 404 at relay.pkarr.org, verified 2026-08), so any example DID is
  // a guaranteed notFound. The method itself stays fully supported.
  // {
  //   id: "dht",
  //   glyph: "M",
  //   probation: true,
...
/** Network labels for methods without a featured tile (prominent upstream
 * routes, plus locally driven methods whose tile is hidden). */
